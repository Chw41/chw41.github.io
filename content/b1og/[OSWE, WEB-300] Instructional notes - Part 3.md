...
tags:
  - offsec
description: "OSWA WEB-300 筆記 Part 3，涵蓋 Password Reset Vulnerability、XML Parsing、XXE Exploit、openCRX 身份繞過與 RCE、ERPNext 身份繞過、openITCOCKPIT XSS、DOM-based XSS 等等。"
---
